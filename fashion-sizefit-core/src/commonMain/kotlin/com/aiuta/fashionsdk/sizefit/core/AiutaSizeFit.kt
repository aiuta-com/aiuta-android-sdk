...
/**
 * Default Kotlin extension for creating [AiutaSizeFit]
 *
 * @return new instance of [AiutaSizeFit]
 */
public val Aiuta.sizeFit: AiutaSizeFit
    get() = AiutaSizeFitImpl.create(aiuta = this)
