...
// State
internal fun <T : SharedImageTransitionModel> SharedImageController<T>.enableSharingState() = changeSharingState(SharedImageState.ENABLE)

internal fun <T : SharedImageTransitionModel> SharedImageController<T>.disableSharingState() = changeSharingState(SharedImageState.DISABLE)
