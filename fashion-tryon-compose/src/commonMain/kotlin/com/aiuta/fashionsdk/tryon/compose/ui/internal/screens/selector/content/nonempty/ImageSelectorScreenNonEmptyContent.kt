...
import com.aiuta.fashionsdk.tryon.compose.ui.internal.screens.selector.components.body.ImageSelectorPhoto
...
internal fun ImageSelectorScreenNonEmptyContent(modifier: Modifier = Modifier) {
    ...
    val isTryOnButtonVisible = remember {
        derivedStateOf {
